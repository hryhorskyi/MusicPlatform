...
RSpec.describe Invitations::Update::SendEmail do
  describe '.call' do
    ...
    context 'with correct job params' do
      ...
      it 'has correct job args' do
        ...
        expect([mailer_class, mail_action, invitation_id]).to eq(['InvitationMailer', 'update', invitation.id])
      end
    end
  end
end
